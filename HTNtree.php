...
class HTNtree  {
    ...
    public function getTemplateDrugs(){
        $template_drugs = array(
             "ACEI"     => array("Lisinopril 10mg", "Lisinopril 20mg", "Lisinopril 40mg")
            ,"Diuretic" => array("HCTZ 12.5mg", "HCTZ 25mg")
            ,"Spirno"   => array("Spirnolactone 12.5mg", "Spirnolactone 25mg", "Eplerenone 1 Daily", "Eplerenone 1 Bidaily")
            ,"ARB"      => array("Losartan 50mg","Losartan 100mg")
            ,"CCB"      => array("Amlodipine 2.5mg", "Amlodipine 5mg", "Amlodipine 10mg")
            ,"BB"       => array("Bisoprolol 2.5mg",  "Bisoprolol 5mg", "Bisoprolol 7.5mg", "Bisoprolol 10mg")
        );

        return $template_drugs;
    }

    public function treeLogic(){
        $template_drugs = $this->getTemplateDrugs();
